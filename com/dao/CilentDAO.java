...
public interface CilentDAO {
    ...
    public int New_Cilent(String ch_name, String en_name, String sex, String idcard_type, String idcard_num,
    ...
    public int New_Card(String ch_name, String id_card_num, String card_type, String net_id, String phone,
                        String password);
